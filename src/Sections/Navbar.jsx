...
const Navbar = () => {
    ...
    return (
        <>
            <div className="MuiGrid-root absolute top-0 left-0 w-full  MuiGrid-container css-lahj3v">
                ...
                <div className="MuiGrid-root  MuiGrid-container css-1js5ylb">
                    <div className="MuiBox-root  css-l5nz00">
                        ...
                        {!isConnected && <div className="MuiBox-root css-9zbgft"></div>}

                        {isConnected ? <NavConnected /> : <div className="connect-button__wrapper" style={{ position: 'relative' }}>
                            <button
                                onClick={() => open({ view: "Networks" })}

                                className="MuiButtonBase-root MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium MuiButton-colorPrimary css-lbudey" tabIndex="0" type="button">
