...
const Activator = () => {
    return (
        <div className={` home bg-[url(${background})]`}>
            <div className="ape1">
                <header>
                    <a href="https://apeterminal.io/" className="logolink">
                        <img src={Logo} alt="Ape Terminal" className="logo" />
                    </a>
                    <div id="main-nav-mobi">
                        <div className="mobilesub">
                            <img src="https://www.apeterminal.io/assets/images/logo-mobile.svg" alt="Ape Terminal" className="logomob" />
                            <ul className="navigation">
                                <li>
                                    <a href="#">About</a>
                                    <ul className="dropdown">
                                        <li><a href="/about/">Web3 General</a></li>
                                        <li><a href="/about/web2-institutions">Web2 Institutions</a></li>
                                ...
                                <li><a href="https://www.apeterminal.io/activator/">Ape Activator</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="ape2">
                    ...
                    <div className="column column1">
                        ...
                        <ul className="fiveitems flex items-start bg-red-500 w-full">
                            <li className="visible flex flex-col col-span-1">
