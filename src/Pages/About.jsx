...
const About = () => {
    return (
        <div className={`  bg-[url(https://www.apeterminal.io/activator/assets/images/background.png)] bg-no-repeat bg-contain bg-top`}>
            ...
            <div className="featured-rapidly container  mx-auto max-w-[1200px]">
            ...
            <div className="featured-ape-launchpad container  mx-auto max-w-[1200px]">
            ...
            <div className="featured-ape-card container  mx-auto max-w-[1200px]">
            ...
            <div className="featured-ape-quarterly container  mx-auto max-w-[1200px]">
                <img src={glowGreen} alt="Glow Green" className="blurbackright" />
